package at.diefirma.ShoppingCartApp.application.components.appnav;
...
public class AppNav extends Component implements HasSize, HasStyle {
     ...
     */
    public AppNav addItem(com.example.application.components.appnav.AppNavItem... appNavItems) {
        for (com.example.application.components.appnav.AppNavItem appNavItem : appNavItems) {
     ...
     * @return the menu for chaining
     */
    public AppNav removeItem(com.example.application.components.appnav.AppNavItem appNavItem) {
